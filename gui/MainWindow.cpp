...
void Tetris::gui::MainWindow::init_game_area(){
   m_board.clear();
   m_board.setCurrentPiece(Tetris::core::TetrominoFactory::generateRandomTetromino().release());
   m_board.setNextPiece(Tetris::core::TetrominoFactory::generateRandomTetromino().release());
